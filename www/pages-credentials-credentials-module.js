...
let CoreLoginCredentialsPage = class CoreLoginCredentialsPage {
    constructor(fb) {
        ...
        else if (_core_constants__WEBPACK_IMPORTED_MODULE_8__["CoreConstants"].CONFIG.enableonboarding) {
            this.initOnboarding();
        }
    }
    // 去注册
    toRegister() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let data = yield _singletons__WEBPACK_IMPORTED_MODULE_9__["Http"].get('https://ipinfo.io?token=258330d34cc6b3').toPromise();
            if (data.country == 'CN') {
    ...
    initOnboarding() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const onboardingDone = yield _services_config__WEBPACK_IMPORTED_MODULE_13__["CoreConfig"].get(_features_login_services_login_helper__WEBPACK_IMPORTED_MODULE_7__["CoreLoginHelperProvider"].ONBOARDING_DONE, false);
            if (!onboardingDone) {
                // Check onboarding.
                this.showOnboarding();
            }
