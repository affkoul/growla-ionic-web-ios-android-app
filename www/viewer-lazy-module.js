...
const routes = [
    {
        path: 'iframe',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-iframe-iframe-module */ "pages-iframe-iframe-module").then(__webpack_require__.bind(null, /*! ./pages/iframe/iframe.module */ "./src/core/features/viewer/pages/iframe/iframe.module.ts")).then(m => m.CoreViewerIframePageModule),
    },
];
